...
an operation known as the scattering transform.
...
The increasing scales in a path $(j_1, \ldots, j_m)$ correspond to the cumulative
sum of integers $j_1$ to $j_m$.


The subsequent features, called scattering transform \cite{mallat2012group},
form a recursive interferometry representation. 
...
Much like the orthogonal wavelet transform, the scattering transform benefits
