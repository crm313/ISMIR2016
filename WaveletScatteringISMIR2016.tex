...
% TODO UPDATE FIGURE 2 WITH NEW INDEX CONVENTIONS
...
% TODO ALIGN THE EQUATION ON THE LEFT
...
generalized to multi-variable settings in the time-frequency domain,
including log-frequency and octave \cite{lostanlen2015wavelet}.

Let us call
$\boldsymbol{x_1}[j_1, b] =
\vert \boldsymbol{Wx}[j_1, b] \vert =
\big \vert \langle \boldsymbol{x} \vert \boldsymbol{\psi_{j_1,b}} \rangle \big \vert$

\begin{IEEEeqnarray}{rCl}
\IEEEeqnarraymulticol{1}{l}{\boldsymbol{S_J x}[j_1, \cdots, j_{m}]}
\nonumber \\
...
Interestingly, the case $m=0$ boils down to the sum across octaves $\boldsymbol{A_J}$
