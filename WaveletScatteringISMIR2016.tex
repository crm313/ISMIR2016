...
It should be noted that $\boldsymbol{A_J x}$ computes a delocalized average of all signal coefficients. Henceforth, it corresponds to the traditional chroma representation, where log-frequency bands of the same pitch class $q$ are summed across all $K$ octaves.
