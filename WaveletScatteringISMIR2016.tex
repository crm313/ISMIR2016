...
Dating back to 1909, the Haar wavelet is a piecewise constant, real function of compact support, consisting of two steps of equal length and opposite values:
\begin{equation}
\forall z \in \mathbb{R}, \;
\psi(z)=\left\{ \begin{array}{rl}
-1 & \mbox{if }-1 < z < 0\\
1 & \mbox{if }\;0 < z < 1\\
0 & \mbox{otherwise}
\end{array}\right.
\end{equation}
Because of its discontinuities, it suffers from 
