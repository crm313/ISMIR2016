...
These intervals are naturally present in harmonic sounds.

%The construction of transposition-invariant chroma features that are able
%to disambiguate chord inversions can be addressed by exploiting
%interferences between overlapping partials.
