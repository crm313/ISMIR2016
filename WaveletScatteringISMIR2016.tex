...
To extend this framework to multi-band chroma features, Cho and Bello
have trained $K$ models in parallel, end-to-end, over each band $k$
of the tensor $\boldsymbol{Y}[t, q, k]$.
At prediction time, the emission probability distributions of each model
are aggregated such that they are the outputs of a single state sequence. 
This follows from assumptions of synchronicity and independence of the
$K$ streams.
